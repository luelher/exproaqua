...
<?php include dirname(__FILE__).'/../../parts/archiveAction.php' ?>

<?php include dirname(__FILE__).'/../../parts/reactivateAction.php' ?>

<?php if (isset($this->params['with_show']) && $this->params['with_show']): ?>
  <?php include dirname(__FILE__).'/../../parts/showAction.php' ?>
<?php endif; ?>

<?php if ($batch_actions = $this->configuration->getValue('list.batch_actions')): ?>
  <?php include dirname(__FILE__).'/../../parts/batchAction.php' ?>
  <?php if (isset($batch_actions['batchArchiveReactivate'])): ?>
    <?php include dirname(__FILE__).'/../../parts/archiveReactivateBatchAction.php' ?>
  <?php endif; ?>
<?php endif; ?>
