...
<?php unset($this->config['list']['layout']) ?>
  ...
  {
    return '<?php echo $this->escapeString(isset($this->config['list']['title']) ? $this->config['list']['title'] : ucfirst(Doctrine::getTable($this->getModelClass())->getSingularName()).' List') ?>';
<?php unset($this->config['list']['title']) ?>
  }

  public function getEditTitle()
  {
    return '<?php echo $this->escapeString(isset($this->config['edit']['title']) ? $this->config['edit']['title'] : 'Edit '.ucfirst(Doctrine::getTable($this->getModelClass())->getSingularName())) ?>';
<?php unset($this->config['edit']['title']) ?>
  }

  public function getNewTitle()
  {
    return '<?php echo $this->escapeString(isset($this->config['new']['title']) ? $this->config['new']['title'] : 'New '.ucfirst(Doctrine::getTable($this->getModelClass())->getSingularName())) ?>';
