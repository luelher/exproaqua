...
/**
 * Opermv form base class.
 *
 * @method Opermv getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BaseOpermvForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'recargounit'       => new sfWidgetFormInputText(),
      'preciooriginal'    => new sfWidgetFormInputText(),
      ...
      'se_imprimio'       => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'pid'               => new sfValidatorString(array('max_length' => 12)),
      ...
      'recargounit'       => new sfValidatorNumber(array('required' => false)),
      'preciooriginal'    => new sfValidatorNumber(array('required' => false)),
      ...
      'se_imprimio'       => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('opermv[%s]');
