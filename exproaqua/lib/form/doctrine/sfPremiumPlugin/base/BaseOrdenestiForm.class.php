...
/**
 * Ordenesti form base class.
 *
 * @method Ordenesti getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BaseOrdenestiForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'fechafac'   => new sfValidatorDate(array('required' => false)),
      ...
      'kilometros' => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ordenesti[%s]');
