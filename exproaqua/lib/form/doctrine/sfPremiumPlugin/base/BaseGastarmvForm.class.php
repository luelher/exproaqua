...
/**
 * Gastarmv form base class.
 *
 * @method Gastarmv getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BaseGastarmvForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dsctoendmto'    => new sfWidgetFormInputText(),
      'dsctoendprc'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'dsctoendmto'    => new sfValidatorNumber(array('required' => false)),
      'dsctoendprc'    => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('gastarmv[%s]');
