...
/**
 * Comisionvend form base class.
 *
 * @method Comisionvend getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BaseComisionvendForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('comisionvend[%s]');
