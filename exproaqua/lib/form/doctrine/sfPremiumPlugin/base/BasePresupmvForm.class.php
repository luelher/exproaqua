...
/**
 * Presupmv form base class.
 *
 * @method Presupmv getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BasePresupmvForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('presupmv[%s]');
