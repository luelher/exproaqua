...
/**
 * Tdebtab form base class.
 *
 * @method Tdebtab getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BaseTdebtabForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tdebtab[%s]');
