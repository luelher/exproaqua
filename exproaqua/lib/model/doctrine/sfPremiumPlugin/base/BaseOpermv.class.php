...
Doctrine_Manager::getInstance()->bindComponent('Opermv', 'premium');
 ...
 * @method float   getRecargounit()       Returns the current record's "recargounit" value
 * @method float   getPreciooriginal()    Returns the current record's "preciooriginal" value
 ...
 * @method float   getSeImprimio()        Returns the current record's "se_imprimio" value
 ...
 * @method Opermv  setId()                Sets the current record's "id" value
 * @method Opermv  setIdEmpresa()         Sets the current record's "id_empresa" value
 * @method Opermv  setAgencia()           Sets the current record's "agencia" value
 * @method Opermv  setTipodoc()           Sets the current record's "tipodoc" value
 * @method Opermv  setDocumento()         Sets the current record's "documento" value
 * @method Opermv  setGrupo()             Sets the current record's "grupo" value
 * @method Opermv  setSubgrupo()          Sets the current record's "subgrupo" value
 * @method Opermv  setOrigen()            Sets the current record's "origen" value
 * @method Opermv  setCodigo()            Sets the current record's "codigo" value
 * @method Opermv  setCodhijo()           Sets the current record's "codhijo" value
 * @method Opermv  setPid()               Sets the current record's "pid" value
 * @method Opermv  setNombre()            Sets the current record's "nombre" value
 * @method Opermv  setCostounit()         Sets the current record's "costounit" value
 * @method Opermv  setPreciounit()        Sets the current record's "preciounit" value
 * @method Opermv  setDiferencia()        Sets the current record's "diferencia" value
 * @method Opermv  setDsctounit()         Sets the current record's "dsctounit" value
 * @method Opermv  setDsctoprc()          Sets the current record's "dsctoprc" value
 * @method Opermv  setDsctoendm()         Sets the current record's "dsctoendm" value
 * @method Opermv  setDsctoendp()         Sets the current record's "dsctoendp" value
 * @method Opermv  setPreciofin()         Sets the current record's "preciofin" value
 * @method Opermv  setPrcrecargo()        Sets the current record's "prcrecargo" value
 * @method Opermv  setRecargounit()       Sets the current record's "recargounit" value
 * @method Opermv  setPreciooriginal()    Sets the current record's "preciooriginal" value
 * @method Opermv  setCantidad()          Sets the current record's "cantidad" value
 * @method Opermv  setCntdevuelt()        Sets the current record's "cntdevuelt" value
 * @method Opermv  setCntentrega()        Sets the current record's "cntentrega" value
 * @method Opermv  setTallas()            Sets the current record's "tallas" value
 * @method Opermv  setColores()           Sets the current record's "colores" value
 * @method Opermv  setMontoneto()         Sets the current record's "montoneto" value
 * @method Opermv  setMontototal()        Sets the current record's "montototal" value
 * @method Opermv  setAlmacen()           Sets the current record's "almacen" value
 * @method Opermv  setProveedor()         Sets the current record's "proveedor" value
 * @method Opermv  setFechadoc()          Sets the current record's "fechadoc" value
 * @method Opermv  setImpuesto1()         Sets the current record's "impuesto1" value
 * @method Opermv  setImpuesto2()         Sets the current record's "impuesto2" value
 * @method Opermv  setImpuesto3()         Sets the current record's "impuesto3" value
 * @method Opermv  setImpuesto4()         Sets the current record's "impuesto4" value
 * @method Opermv  setImpuesto5()         Sets the current record's "impuesto5" value
 * @method Opermv  setImpuesto6()         Sets the current record's "impuesto6" value
 * @method Opermv  setTimpueprc()         Sets the current record's "timpueprc" value
 * @method Opermv  setImpuMto()           Sets the current record's "impu_mto" value
 * @method Opermv  setComision()          Sets the current record's "comision" value
 * @method Opermv  setComisprc()          Sets the current record's "comisprc" value
 * @method Opermv  setVendedor()          Sets the current record's "vendedor" value
 * @method Opermv  setEmisor()            Sets the current record's "emisor" value
 * @method Opermv  setUsaserial()         Sets the current record's "usaserial" value
 * @method Opermv  setTipoprecio()        Sets the current record's "tipoprecio" value
 * @method Opermv  setUnidad()            Sets the current record's "unidad" value
 * @method Opermv  setAgrupado()          Sets the current record's "agrupado" value
 * @method Opermv  setCntagrupada()       Sets the current record's "cntagrupada" value
 * @method Opermv  setSeimporto()         Sets the current record's "seimporto" value
 * @method Opermv  setDesdeimpor()        Sets the current record's "desdeimpor" value
 * @method Opermv  setNotas()             Sets the current record's "notas" value
 * @method Opermv  setOferta()            Sets the current record's "oferta" value
 * @method Opermv  setCompuesto()         Sets the current record's "compuesto" value
 * @method Opermv  setUsaexist()          Sets the current record's "usaexist" value
 * @method Opermv  setMarca()             Sets the current record's "marca" value
 * @method Opermv  setAux1()              Sets the current record's "aux1" value
 * @method Opermv  setEstacion()          Sets the current record's "estacion" value
 * @method Opermv  setClasifica()         Sets the current record's "clasifica" value
 * @method Opermv  setCuentacont()        Sets the current record's "cuentacont" value
 * @method Opermv  setPlaca()             Sets the current record's "placa" value
 * @method Opermv  setUdinamica()         Sets the current record's "udinamica" value
 * @method Opermv  setCantref()           Sets the current record's "cantref" value
 * @method Opermv  setUnidadref()         Sets the current record's "unidadref" value
 * @method Opermv  setBaseimpo1()         Sets the current record's "baseimpo1" value
 * @method Opermv  setBaseimpo2()         Sets the current record's "baseimpo2" value
 * @method Opermv  setBaseimpo3()         Sets the current record's "baseimpo3" value
 * @method Opermv  setLote()              Sets the current record's "lote" value
 * @method Opermv  setImpNacional()       Sets the current record's "imp_nacional" value
 * @method Opermv  setImpProducc()        Sets the current record's "imp_producc" value
 * @method Opermv  setSeImprimio()        Sets the current record's "se_imprimio" value
 * @method Opermv  setOfertaconvenio()    Sets the current record's "ofertaconvenio" value
 * @method Opermv  setCodServidor()       Sets the current record's "cod_servidor" value
 * @method Opermv  setPrcComiServidor()   Sets the current record's "prc_comi_servidor" value
 * @method Opermv  setMtoComiServidor()   Sets the current record's "mto_comi_servidor" value
 * 
 * @package    exproaqua
 * @subpackage model
 ...
 */
abstract class BaseOpermv extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('opermv');
        ...
        $this->hasColumn('recargounit', 'float', 20, array(
             'type' => 'float',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
        ...
        $this->hasColumn('preciooriginal', 'float', 20, array(
             'type' => 'float',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
        ...
        $this->hasColumn('se_imprimio', 'float', 4, array(
             'type' => 'float',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
