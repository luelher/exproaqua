...
/**
 * Compmov form base class.
 *
 * @method Compmov getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BaseCompmovForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('compmov[%s]');
