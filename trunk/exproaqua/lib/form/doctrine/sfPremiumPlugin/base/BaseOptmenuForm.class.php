...
/**
 * Optmenu form base class.
 *
 * @method Optmenu getObject() Returns the current form's model object
 *
 * @package    exproaqua
 * @subpackage form
 ...
 */
abstract class BaseOptmenuForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'baby'       => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'baby'       => new sfValidatorString(array('max_length' => 1, 'required' => false)),
      'submenu'    => new sfValidatorString(array('max_length' => 1, 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('optmenu[%s]');
