 ...
 */
abstract class BaseOpertiFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'moneda'            => new sfWidgetFormFilterInput(),
      'codcliente'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'ult_interes'       => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => false)),
      ...
      'planillacob'       => new sfWidgetFormFilterInput(),
      'nodoremoto'        => new sfWidgetFormFilterInput(),
      'turno'             => new sfWidgetFormFilterInput(),
      'codvend_a'         => new sfWidgetFormFilterInput(),
      'codvend_b'         => new sfWidgetFormFilterInput(),
      'codvend_c'         => new sfWidgetFormFilterInput(),
      'codvend_d'         => new sfWidgetFormFilterInput(),
      ...
      'serialprintf'      => new sfWidgetFormFilterInput(),
      'documentofiscal'   => new sfWidgetFormFilterInput(),
      'ubica'             => new sfWidgetFormFilterInput(),
      'usa_despacho'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'despachador'       => new sfWidgetFormFilterInput(),
      'despacho_nro'      => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ));

    $this->setValidators(array(
      'moneda'            => new sfValidatorPass(array('required' => false)),
      'codcliente'        => new sfValidatorPass(array('required' => false)),
      ...
      'ult_interes'       => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
      ...
      'planillacob'       => new sfValidatorPass(array('required' => false)),
      'nodoremoto'        => new sfValidatorPass(array('required' => false)),
      'turno'             => new sfValidatorPass(array('required' => false)),
      'codvend_a'         => new sfValidatorPass(array('required' => false)),
      'codvend_b'         => new sfValidatorPass(array('required' => false)),
      'codvend_c'         => new sfValidatorPass(array('required' => false)),
      'codvend_d'         => new sfValidatorPass(array('required' => false)),
      ...
      'iddocumento'       => new sfValidatorPass(array('required' => false)),
      ...
      'serialprintf'      => new sfValidatorPass(array('required' => false)),
      'documentofiscal'   => new sfValidatorPass(array('required' => false)),
      'ubica'             => new sfValidatorPass(array('required' => false)),
      'usa_despacho'      => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'despachador'       => new sfValidatorPass(array('required' => false)),
      'despacho_nro'      => new sfValidatorPass(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('operti_filters[%s]');
