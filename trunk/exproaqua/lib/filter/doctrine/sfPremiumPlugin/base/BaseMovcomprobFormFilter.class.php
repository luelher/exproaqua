...
/**
 * Movcomprob filter form base class.
 *
 * @package    exproaqua
 * @subpackage filter
 ...
 */
abstract class BaseMovcomprobFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('movcomprob_filters[%s]');
