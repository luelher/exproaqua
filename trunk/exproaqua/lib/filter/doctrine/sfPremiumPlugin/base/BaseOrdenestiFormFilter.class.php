...
/**
 * Ordenesti filter form base class.
 *
 * @package    exproaqua
 * @subpackage filter
 ...
 */
abstract class BaseOrdenestiFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fechafac'   => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => false)),
      ...
      'kilometros' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'fechafac'   => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
      ...
      'kilometros' => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('ordenesti_filters[%s]');
