...
/**
 * Conveniostabti filter form base class.
 *
 * @package    exproaqua
 * @subpackage filter
 ...
 */
abstract class BaseConveniostabtiFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('conveniostabti_filters[%s]');
